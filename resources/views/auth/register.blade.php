...
<div class="bg-dark flex justify-center pt-4">
    ...
    @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" name="username" id="username" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('username') border-red-500 @enderror" placeholder="your UserName" value="{{old('username')}}">
                @error('username')
                    <div class="text-red-500 mt-2 text-sm">{{$message}}</div>
                @enderror
            </div>
